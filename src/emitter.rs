...
unsafe fn yaml_emitter_emit_alias(
    ...
    if (*emitter).simple_key_context != 0 {
        if !((((*emitter).buffer.pointer).wrapping_offset(5 as libc::c_int as isize)
            < (*emitter).buffer.end
...
unsafe fn yaml_emitter_check_empty_sequence(emitter: *mut yaml_emitter_t) -> libc::c_int {
    ...
    ((*((*emitter).events.head).wrapping_offset(0 as libc::c_int as isize)).type_0 as libc::c_uint
        == YAML_SEQUENCE_START_EVENT as libc::c_int as libc::c_uint
        && (*((*emitter).events.head).wrapping_offset(1 as libc::c_int as isize)).type_0
            as libc::c_uint
...
unsafe fn yaml_emitter_analyze_tag_directive(
    ...
    if *(handle.start).wrapping_offset(0 as libc::c_int as isize) as libc::c_int != '!' as i32 {
        return yaml_emitter_set_emitter_error(
            emitter,
            b"tag handle must start with '!'\0" as *const u8 as *const libc::c_char,
        );
    }
    if *(handle.end).wrapping_offset(-(1 as libc::c_int) as isize) as libc::c_int != '!' as i32 {
        return yaml_emitter_set_emitter_error(
            emitter,
    ...
    while handle.pointer < (handle.end).wrapping_offset(-(1 as libc::c_int as isize)) {
        if !(*(handle.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
            >= '0' as i32 as yaml_char_t as libc::c_int
            && *(handle.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
        ...
        handle.pointer = (handle.pointer).wrapping_offset(
            ...
            {
                1 as libc::c_int
            } else if *(handle.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
                & 0xe0 as libc::c_int
                == 0xc0 as libc::c_int
            {
                2 as libc::c_int
...
unsafe fn yaml_emitter_analyze_anchor(
    ...
    while string.pointer != string.end {
        if !(*(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
            >= '0' as i32 as yaml_char_t as libc::c_int
            && *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
                <= '9' as i32 as yaml_char_t as libc::c_int
            || *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
                >= 'A' as i32 as yaml_char_t as libc::c_int
                && *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
        ...
        string.pointer = (string.pointer).wrapping_offset(
            ...
            {
                1 as libc::c_int
            } else if *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
                & 0xe0 as libc::c_int
                == 0xc0 as libc::c_int
            {
                2 as libc::c_int
...
unsafe fn yaml_emitter_analyze_scalar(
    ...
    *fresh51 = value;
    ...
    if *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
        ...
        && *(string.pointer).wrapping_offset(1 as libc::c_int as isize) as libc::c_int
            == '-' as i32 as yaml_char_t as libc::c_int
        && *(string.pointer).wrapping_offset(2 as libc::c_int as isize) as libc::c_int
            == '-' as i32 as yaml_char_t as libc::c_int
        || *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
            == '.' as i32 as yaml_char_t as libc::c_int
            && *(string.pointer).wrapping_offset(1 as libc::c_int as isize) as libc::c_int
    ...
    followed_by_whitespace = (*(string.pointer).wrapping_offset(
        ...
        || (*(string.pointer).wrapping_offset(
            ...
            || *(string.pointer).wrapping_offset(
                ...
                {
                    1 as libc::c_int
                } else if *(string.pointer).wrapping_offset(0 as libc::c_int as isize)
                    as libc::c_int
                    & 0xe0 as libc::c_int
                    == 0xc0 as libc::c_int
                {
    ...
    while string.pointer != string.end {
        ...
        if !(*(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
            ...
            || *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
                == 0xc2 as libc::c_int
                && *(string.pointer).wrapping_offset((0 as libc::c_int + 1 as libc::c_int) as isize)
                    as libc::c_int
                    >= 0xa0 as libc::c_int
            || *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
                > 0xc2 as libc::c_int
        ...
        if *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
            ...
            || *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
                ...
                && *(string.pointer).wrapping_offset((0 as libc::c_int + 1 as libc::c_int) as isize)
                    as libc::c_int
                    == -128i32 as yaml_char_t as libc::c_int
                && *(string.pointer).wrapping_offset((0 as libc::c_int + 2 as libc::c_int) as isize)
                    as libc::c_int
                    == -88i32 as yaml_char_t as libc::c_int
            || *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
                == -30i32 as yaml_char_t as libc::c_int
        ...
        if string.pointer != string.end {
            followed_by_whitespace = (*(string.pointer).wrapping_offset(
                ...
                || (*(string.pointer).wrapping_offset(
                    ...
                    == '\r' as i32 as yaml_char_t as libc::c_int
                    || *(string.pointer).wrapping_offset(
                        (if *(string.pointer).wrapping_offset(0 as libc::c_int as isize)
                            as libc::c_int
                            & 0x80 as libc::c_int
                            == 0 as libc::c_int
                        {
...
unsafe fn yaml_emitter_write_plain_scalar(
    ...
    while string.pointer != string.end {
            ...
            == ' ' as i32 as yaml_char_t as libc::c_int
        {
            ...
            } else if !((((*emitter).buffer.pointer).wrapping_offset(5 as libc::c_int as isize)
                < (*emitter).buffer.end
                || yaml_emitter_flush(emitter) != 0)
                && {
                    if *string.pointer as libc::c_int & 0x80 as libc::c_int == 0 as libc::c_int {
    ...
    while string.pointer != string.end {
            ...
            == ' ' as i32 as yaml_char_t as libc::c_int
        {
            if allow_breaks != 0
                ...
                && string.pointer != (string.end).wrapping_offset(-(1 as libc::c_int as isize))
                && !(*(string.pointer).wrapping_offset(1 as libc::c_int as isize) as libc::c_int
                    == ' ' as i32 as yaml_char_t as libc::c_int)
            {
                if yaml_emitter_write_indent(emitter) == 0 {
...
unsafe fn yaml_emitter_write_double_quoted_scalar(
    ...
    while string.pointer != string.end {
                ...
                == '\\' as i32 as yaml_char_t as libc::c_int
        {
            ...
            octet = *(string.pointer).wrapping_offset(0 as libc::c_int as isize);
            ...
            == ' ' as i32 as yaml_char_t as libc::c_int
        {
                ...
                && string.pointer != (string.end).wrapping_offset(-(1 as libc::c_int as isize))
            {
                ...
                if *(string.pointer).wrapping_offset(1 as libc::c_int as isize) as libc::c_int
                    == ' ' as i32 as yaml_char_t as libc::c_int
                {
                    if !((((*emitter).buffer.pointer).wrapping_offset(5 as libc::c_int as isize)
                        < (*emitter).buffer.end
                    ...
                    == -87i32 as yaml_char_t as libc::c_int
        {
                    ...
                    == '\n' as i32 as yaml_char_t as libc::c_int
            {
                ...
                while *(string.pointer).wrapping_offset(k as isize) as libc::c_int
                    ...
                    || *(string.pointer).wrapping_offset(k as isize) as libc::c_int
                        == -62i32 as yaml_char_t as libc::c_int
                        && *(string.pointer).wrapping_offset((k + 1 as libc::c_int) as isize)
                            as libc::c_int
                            == -123i32 as yaml_char_t as libc::c_int
                    || *(string.pointer).wrapping_offset(k as isize) as libc::c_int
                        == -30i32 as yaml_char_t as libc::c_int
                        && *(string.pointer).wrapping_offset((k + 1 as libc::c_int) as isize)
                            as libc::c_int
                            == -128i32 as yaml_char_t as libc::c_int
                        && *(string.pointer).wrapping_offset((k + 2 as libc::c_int) as isize)
                            as libc::c_int
                            == -88i32 as yaml_char_t as libc::c_int
                    || *(string.pointer).wrapping_offset(k as isize) as libc::c_int
                        == -30i32 as yaml_char_t as libc::c_int
                        ...
                        && *(string.pointer).wrapping_offset((k + 2 as libc::c_int) as isize)
                            ...
                            == -87i32 as yaml_char_t as libc::c_int
                {
                    k += if *(string.pointer).wrapping_offset(k as isize) as libc::c_int
                        & 0x80 as libc::c_int
                        == 0 as libc::c_int
                    {
                        1 as libc::c_int
            ...
            if breaks != 0 {
                ...
                leading_spaces = (*(string.pointer).wrapping_offset(0 as libc::c_int as isize)
                    as libc::c_int
                    == ' ' as i32 as yaml_char_t as libc::c_int
                    || *(string.pointer).wrapping_offset(0 as libc::c_int as isize) as libc::c_int
                        == '\t' as i32 as yaml_char_t as libc::c_int)
