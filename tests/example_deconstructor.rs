...
unsafe fn main_0(
    ...
    if !(yaml_stream_start_event_initialize(&mut output_event, YAML_UTF8_ENCODING) == 0)
    {
        if yaml_emitter_emit(&mut emitter, &mut output_event) == 0 {
            current_block = 14333022441030226928;
            ...
            {
            current_block = 3553279562225877243;
            ...
            's_218: loop {
                ...
                if yaml_parser_parse(&mut parser, &mut input_event) == 0 {
                    current_block = 11658590068804198828;
                    break;
                }
                ...
                match input_event.type_0 as libc::c_uint {
                    ...
                    6 => {
                        ...
                        if yaml_scalar_event_initialize(
                            ...
                            b"tag:yaml.org,2002:str\0" as *const u8
                                as *const libc::c_char as *mut yaml_char_t,
                            b"non-plain\0" as *const u8 as *const libc::c_char
                                as *mut yaml_char_t,
                            -(1 as libc::c_int),
                            1 as libc::c_int,
                            1 as libc::c_int,
            ...
            match current_block {
                14333022441030226928 => {}
                3553279562225877243 => {}
                _ => {
                    match current_block {
                        11658590068804198828 => {
                                ...
                                3 => {
                                    if !(parser.context).is_null() {
                                        fprintf(
                                            ...
                                            parser.context_mark.column as libc::c_int
                                                + 1 as libc::c_int,
                                            parser.problem,
