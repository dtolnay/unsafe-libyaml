...
extern "C" {
    ...
    fn yaml_get_version_string() -> *const libc::c_char;
    fn yaml_get_version(
...
unsafe fn main_0() -> libc::c_int {
    let mut major: libc::c_int = -(1 as libc::c_int);
    let mut minor: libc::c_int = -(1 as libc::c_int);
    let mut patch: libc::c_int = -(1 as libc::c_int);
    ...
    if strcmp(buf.as_mut_ptr(), yaml_get_version_string()) == 0 as libc::c_int {} else {
        __assert_fail(
            b"strcmp(buf, yaml_get_version_string()) == 0\0" as *const u8
                as *const libc::c_char,
            b"test-version.c\0" as *const u8 as *const libc::c_char,
    ...
    printf(
        ...
        ::std::mem::size_of::<yaml_token_t>() as libc::c_ulong as libc::c_long,
    );
    printf(
        b"sizeof(event) = %ld\n\0" as *const u8 as *const libc::c_char,
        ::std::mem::size_of::<yaml_event_t>() as libc::c_ulong as libc::c_long,
    );
    printf(
        b"sizeof(parser) = %ld\n\0" as *const u8 as *const libc::c_char,
        ::std::mem::size_of::<yaml_parser_t>() as libc::c_ulong as libc::c_long,
    );
